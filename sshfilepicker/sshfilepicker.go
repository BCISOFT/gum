// Package sshfilepicker provides a file picker component for Bubble Tea
// applications.
...
// New returns a new sshfilepicker model with default styling and key bindings.
func New() Model {
	return Model{
		id:               nextID(),
		CurrentDirectory: ".",
...
// SetHeight sets the height of the sshfilepicker.
